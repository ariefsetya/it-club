        ...
        <ul class="m-menu" >
            ...
            <li>
                ...
                <div class="m-menu-container" data-role="dropdown" data-no-close="true">
                    <div class="grid no-margin">
                        <div class="row cells5">
                            <?php $profile = App\User::whereRaw('namadepan<>"" and namabelakang<>"" and tanggallahir<>"0000-00-00" and blokir=0 and (foto<>1 or foto<>"") and hubungan<>"" and namapanggilan<>""')->orderByRaw('rand()')->first(); ?>
                            @if(sizeof($profile)==1)
                            <div class="cell padding10">
