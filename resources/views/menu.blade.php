        ...
        <ul class="m-menu" >
            ...
            <li>
                ...
                <div class="m-menu-container" data-role="dropdown">
                    ...
                    @foreach(App\Category::where('deleted_at',NULL)->get() as $data)
                        <li><a style="font-size: {{sizeof(App\Posts::where('id_category',$data->id)->get())}}pt" href="{{ url('search/'.$data->id) }}">{{ $data->nama }}</a></li>
                    @endforeach
                    </ul>
                </div>
            </li>
            ...
            <li>
                ...
                <div class="m-menu-container" data-role="dropdown" data-no-close="true">
                    <div class="grid no-margin">
                        <div class="row cells5">
                            <?php $profile = App\User::whereRaw('namadepan<>"" and namabelakang<>"" and tanggallahir<>"0000-00-00" and blokir=0 and foto<>1')->orderByRaw('rand()')->first(); ?>
                            @if(sizeof($profile)==1)
                            <div class="cell padding10">
