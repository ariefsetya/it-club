...
<a href="{{ url('mine/dashboard') }}" data-role="hint"
    ...
    data-hint="Go to Dashboard|" class="icon mif-home fg-white"></a>			        <span class="title">Edit Divisi</span>
				    ...
				    <form method="POST" action="{{ url('admin/divisi/update') }}" enctype="multipart/form-data">
				        <table style="width:100%">
				        	...
				        	<tr>
				        		<td>Image</td>
				        		<td>
				        			<img src="{{ url('images/gambardivisi/'.$divisi->gambar) }}">
				        	...
				        	<tr>
				        		...
				        		<td>
				        			<div class="input-control textarea full-size">
									    <textarea name="keterangan" required>{{ $divisi->keterangan }}</textarea>
									</div>
				        		</td>
				        	</tr>
				        	<tr>
